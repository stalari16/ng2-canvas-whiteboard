...
var CanvasWhiteboardShapeService = /** @class */ (function () {
    function CanvasWhiteboardShapeService() {
        this._registeredShapesSubject = new rxjs.BehaviorSubject([
            FreeHandShape,
            LineShape,
            RectangleShape,
            CircleShape,
    ...
    CanvasWhiteboardShapeService.prototype.getShapeConstructorFromShapeName = function (shapeName) {
         ...
         * @param {?} shape
         * @return {?}
         */function (shape) { return (new shape).getShapeName() === shapeName; }));
    };
    /**
     * @return {?}
     */
    ...
    CanvasWhiteboardShapeService.prototype.unregisterShape = function (shape) {
         ...
         * @return {?}
         */function (registeredShape) { return registeredShape !== shape; })));
    };
    /**
     * @param {?} shapes
     * @return {?}
    ...
    CanvasWhiteboardShapeService.prototype.unregisterShapes = function (shapes) {
         ...
         * @param {?} shape
         * @return {?}
         */function (shape) { return shapes.indexOf(shape) === -1; })));
    };
...
var CanvasWhiteboardComponent = /** @class */ (function () {
    ...
    function CanvasWhiteboardComponent(ngZone, _changeDetector, _canvasWhiteboardService, _canvasWhiteboardShapeService) {
        ...
        this.onUndo = new _angular_core.EventEmitter();
        this.onRedo = new _angular_core.EventEmitter();
        this.onBatchUpdate = new _angular_core.EventEmitter();
        this.onImageLoaded = new _angular_core.EventEmitter();
    ...
    CanvasWhiteboardComponent.prototype.generateCanvasBlob = function (callbackFn, returnedDataType, returnedDataQuality) {
        ...
        if (typeof this.context.canvas.toBlob !== "undefined") {
             ...
             * @return {?}
             */function (callback) {
                callback && callback((( /** @type {?} */(_this.context.canvas))).msToBlob());
            });
        }
    ...
    CanvasWhiteboardComponent.prototype.ngOnDestroy = function () {
         ...
         * @param {?} subscription
         * @return {?}
         */ subscription) { return _this._unsubscribe(subscription); }));
    };
...
CanvasWhiteboardComponent.propDecorators = {
    ...
    batchUpdateTimeoutDuration: [{ type: _angular_core.Input }],
    imageUrl: [{ type: _angular_core.Input }],
    aspectRatio: [{ type: _angular_core.Input }],
    drawButtonClass: [{ type: _angular_core.Input }],
    clearButtonClass: [{ type: _angular_core.Input }],
    undoButtonClass: [{ type: _angular_core.Input }],
    redoButtonClass: [{ type: _angular_core.Input }],
    saveDataButtonClass: [{ type: _angular_core.Input }],
    drawButtonText: [{ type: _angular_core.Input }],
    clearButtonText: [{ type: _angular_core.Input }],
    undoButtonText: [{ type: _angular_core.Input }],
    redoButtonText: [{ type: _angular_core.Input }],
    saveDataButtonText: [{ type: _angular_core.Input }],
    drawButtonEnabled: [{ type: _angular_core.Input }],
    clearButtonEnabled: [{ type: _angular_core.Input }],
    undoButtonEnabled: [{ type: _angular_core.Input }],
    redoButtonEnabled: [{ type: _angular_core.Input }],
    saveDataButtonEnabled: [{ type: _angular_core.Input }],
    shouldDownloadDrawing: [{ type: _angular_core.Input }],
    colorPickerEnabled: [{ type: _angular_core.Input }],
    lineWidth: [{ type: _angular_core.Input }],
    strokeColor: [{ type: _angular_core.Input }],
    startingColor: [{ type: _angular_core.Input }],
    scaleFactor: [{ type: _angular_core.Input }],
    drawingEnabled: [{ type: _angular_core.Input }],
    showStrokeColorPicker: [{ type: _angular_core.Input }],
    showFillColorPicker: [{ type: _angular_core.Input }],
    downloadedFileName: [{ type: _angular_core.Input }],
    lineJoin: [{ type: _angular_core.Input }],
    lineCap: [{ type: _angular_core.Input }],
    shapeSelectorEnabled: [{ type: _angular_core.Input }],
    showShapeSelector: [{ type: _angular_core.Input }],
    fillColor: [{ type: _angular_core.Input }],
    onClear: [{ type: _angular_core.Output }],
    onUndo: [{ type: _angular_core.Output }],
    onRedo: [{ type: _angular_core.Output }],
    onBatchUpdate: [{ type: _angular_core.Output }],
    onImageLoaded: [{ type: _angular_core.Output }],
    onSave: [{ type: _angular_core.Output }],
    canvas: [{ type: _angular_core.ViewChild, args: ['canvas', { static: true },] }],
    _incompleteShapesCanvas: [{ type: _angular_core.ViewChild, args: ['incompleteShapesCanvas', { static: true },] }]
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
...
var CanvasWhiteboardShapeSelectorComponent = /** @class */ (function () {
    ...
    function CanvasWhiteboardShapeSelectorComponent(_elementRef, _canvasWhiteboardShapeService) {
        ...
        this._canvasWhiteboardShapeService = _canvasWhiteboardShapeService;
        this.showShapeSelector = false;
        this.onToggleShapeSelector = new _angular_core.EventEmitter();
        this.onShapeSelected = new _angular_core.EventEmitter();
...
CanvasWhiteboardShapeSelectorComponent.propDecorators = {
    showShapeSelector: [{ type: _angular_core.Input }],
    selectedShapeConstructor: [{ type: _angular_core.Input }],
    shapeOptions: [{ type: _angular_core.Input }],
    onToggleShapeSelector: [{ type: _angular_core.Output }],
    onShapeSelected: [{ type: _angular_core.Output }]
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
...
var CanvasWhiteboardColorPickerComponent = /** @class */ (function () {
    ...
    function CanvasWhiteboardColorPickerComponent(_elementRef) {
        ...
        this.onToggleColorPicker = new _angular_core.EventEmitter();
        this.onColorSelected = new _angular_core.EventEmitter();
        this.onSecondaryColorSelected = new _angular_core.EventEmitter();
    }
    /**
     * Initialize the canvas drawing context. If we have an aspect ratio set up, the canvas will resize
     * according to the aspect ratio.
...
CanvasWhiteboardColorPickerComponent.propDecorators = {
    ...
    onSecondaryColorSelected: [{ type: _angular_core.Output }]
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
...
CanvasWhiteboardShapePreviewComponent.propDecorators = {
    shapeConstructor: [{ type: _angular_core.Input }],
    shapeOptions: [{ type: _angular_core.Input }],
    canvas: [{ type: _angular_core.ViewChild, args: ['canvasWhiteboardShapePreview', { static: false },] }]
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
...
//# sourceMappingURL=ng2-canvas-whiteboard.umd.js.map
